...
function Userinfo() {
  ...
  return (
    <div style={{ padding: "20px" }}>
      <p
        className="bg-gray-200 h-10 w-20 rounded-lg p-6 hover:bg-gray-100"
        ...
        user.insurance.map((policy, index) => (
          ...
          >
            ...
            <p>
              {policy.type && (
                <>
                  <b>Policy For:</b> {policy.type}
                </>
              )}
            </p>
            <button
              className="h-10 w-20 text-white bg-danger rounded-2"
